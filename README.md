...
The five included games—Number Harbor, Phonics Forest, Shape City Builders, Tiny Ecosystem Rescue, and Pattern Planet—demonstrate different learning loops. Agent-created games receive dedicated `/games/local/:gameId` pages and remain available after refresh on the same device.
