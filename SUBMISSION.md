...
- [ ] Publish the current validated build to the public Sites URL.
- [ ] Create or mirror to a public GitHub repository.
- [ ] Confirm README, MIT license, source, assets, and setup instructions are visible.
- [ ] Test the public URL in a WebMCP-enabled browser with a fresh storage profile.
